...
import { RateLimitType } from "./common/middlewares/rateLimit/types";
...
export const sessionCollection = client.db(SETTINGS.DB_NAME).collection<SessionType>(COLLECTION_SESSIONS);
export const rateLimitCollection = client.db(SETTINGS.DB_NAME).collection<RateLimitType>(COLLECTION_RATE_LIMIT);
